							...
							<Grid item xs={12}>
								<Card id="Card1">
									...
									<div style={{ paddingBottom: "1rem", paddingLeft: "1rem", paddingRight: "1rem" }}>
										...
										<Button variant="contained" color='success' endIcon={<FileUploadIcon />} style={{ marginLeft: "1rem" }}>Export Report</Button>


									</div>
									<Grid container>
										<Grid item xs={12} style={{ paddingLeft: '1rem', paddingRight: '1rem' }}>
							...
							<Grid item xs={12} style={{ paddingTop: "2rem" }}>
								<Card id="Card1">
									...
									<Grid container columnSpacing={2} rowSpacing={2} style={{ paddingTop: "2rem", paddingRight: "1rem", paddingLeft: "1rem", paddingBottom: "2rem" }}>
										...
										<Grid item xs={4}>
											<FormControl fullWidth>
												<InputLabel id="demo-simple-select-label">Job Organization</InputLabel>
												<Select
													labelId="demo-simple-select-label"
													id="demo-simple-select"
										...
										<Grid item xs={4}>
											<FormControl fullWidth>
												<InputLabel id="demo-simple-select-label">Job Post</InputLabel>
												<Select
													labelId="demo-simple-select-label"
													id="demo-simple-select"
