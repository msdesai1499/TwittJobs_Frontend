...
export default function UserSalaryDetail() {
	...
	const handleSubmit = async (e) => {
		...
		loginFormData.append("file", UserSalary.file)
		loginFormData.append("id", UserSalary.id)
		loginFormData.append("salarymonth", UserSalary.salarymonth)
		loginFormData.append("salaryAnnual", UserSalary.salaryAnnual)
		loginFormData.append("expectedsalary", UserSalary.expectedsalary)

		console.log(UserSalary.id);
		console.log(loginFormData.get("salaryAnnual"));
		axios({
			method: "post",
			url: `${base_url}/client/salaryInfo`,
			data: loginFormData,
				...
				<form onSubmit={handleSubmit}>
							...
							<Grid container rowSpacing={4} columnSpacing={4}>
								<Grid item xs={4}>
									<TextField
										...
										autoFocus
										fullWidth
										label="Enter your current salary per Month (in INR)"
										onChange={(e) => {

											setUserSalary({ ...UserSalary, salarymonth: e.target.value })
										}}
									/>
								</Grid>
								...
								<Grid item xs={4}>
									<TextField
										...
										autoFocus
										fullWidth
										label="Enter your current salary per Annum (in INR)"
										onChange={(e) => {

											setUserSalary({ ...UserSalary, salaryAnnual: e.target.value })
										}}
									/>
								</Grid>
								...
								<Grid item xs={4}>
									<TextField
										...
										autoFocus
										fullWidth
										label="Enter your Expected salary per Month (in INR)"
										onChange={(e) => {

											setUserSalary({ ...UserSalary, expectedsalary: e.target.value })
										}}
									/>
								</Grid>
								<Grid item xs={4}>
									<TextField
										...
										onChange={(e) => {
											...
											setUserSalary({ ...UserSalary, file: e.target.files[0] })
										}}
									/>
								</Grid>
							</Grid>
					...
					<div className='container' style={{ paddingTop: "2rem" }}>
						<Grid container columnSpacing={2}>
							...
							<Grid item>
								<Button type="reset" variant='contained' color='error' endIcon={<RestartAltIcon />}>RESET</Button>
							</Grid>
						</Grid>
